...
.
├── data/
│   └── data_info.md                  # Dicionário de dados e descrição das variáveis
├── images/
│   └── dashboard_customers_churn.png  # Imagem/preview do dashboard interativo
├── power_bi/
│   └── Telco-Customer-Churn.pbix     # Arquivo do Power BI Desktop com o dashboard
├── queries/
│   └── 01_data_cleaning.sql          # Query SQL utilizada para tratamento da View
